========================================================================
    MICROSOFT 基础类库 : MIES 项目概述
========================================================================


应用程序向导已为您创建了此 MIES DLL。  此 DLL 不仅演示 
Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 MIES DLL 的每个文件的内容。
...
MIES.h
    这是 DLL 的主头文件。  它声明了 CMIESApp 类。

MIES.cpp
    这是主 DLL 源文件。  它包含 CMIESApp 类。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 MIES.pch 的预编译头 (PCH) 文件和名为 
    StdAfx.obj 的预编译类型文件。
